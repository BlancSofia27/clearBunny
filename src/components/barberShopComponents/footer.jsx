      ...
      <div className="container px-5 py-7 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <div className="w-14 bg-black rounded-full overflow-hidden">
              <img
            ...
            <span className="ml-3 text-xl">Blind Barber Shop</span>
          </a>
          <p className="mt-2 text-sm text-gray-500">
            Agenda una cita con nosotros mediante nuestras redes sociales
          </p>
        </div>
      </div>
